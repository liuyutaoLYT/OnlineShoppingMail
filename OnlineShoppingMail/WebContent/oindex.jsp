    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                <div id="logoDiv">
                    <p id="logoP"><img id="logo" alt="左右结构项目" src="images/logo.png"><span></span></p>
                </div>
                <div id="personInfor">
                    <p id="userName"></p>
                    <p><span></span> <a href="http://www.mycodes.net/" target="_blank"></a></p>
                    <p>
                        <a></a>
                    </p>
                </div>
                ...
                <div class="meun-item"  aria-controls="user" role="tab" data-toggle="tab"><a href="会员列表.html">用户管理</a></div>
